...
#     return render(request, 'ocr/success.html')

def reportToDatabase(file_path):
	connection = pymysql.connect(host = 'localhost', user = 'root', password = '', database = 'agbi_pharma')
	...
	for imgBlob in imageBlobs:
		...
		if(count == 1):
			...
			dataString = ''
			colString = 'name'
			print(patientReportData)

			
			print(type(patientReportCols[1]))
